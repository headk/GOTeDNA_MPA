server <- function(input, output, session){
  ...
  output$species_panel  <- renderUI({ tags$div("...") })
  output$protocol_details <- renderUI({ tags$div("...") })
  ...
  output$protocol_details <- renderUI({
    ...
    field_map <- c(               #I want to section this part into the field, lab and bioinformatic methods visually
      "Year"           = "Year",
      "Volume"         = "Volume",
      "Depth"          = "Depth",
      "Filter pore size"         = NA_character_,
      "Filter material"          = NA_character_,
      "Preservative solution"   = NA_character_,
      "Preservative temperature" = NA_character_,
      "Storage temperature"      = NA_character_,
      "insert name for methods other than filtration" = NA_character_,
      "eDNA/eRNA" = NA_character_,
      "# of extracts pooled prior to PCR" = NA_character_,
      "Extraction kit"  = NA_character_,
      "Target gene"    = NA_character_,
      "Primers"        = "Primers",
      "Sequencer"      = NA_character_,
      "Bioinformatic pipeline" = NA_character_,
      "Bioinformatic filtering threshold" = NA_character_,
      "Reference database" = NA_character_,
      "OTUs/ASVs" = NA_character_
    )
